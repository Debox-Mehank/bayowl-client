...
function DashNav() {
    ...
    return (
        ...
        <aside id="menu" className={`w-80 min-h-screen flex bg-darkBlue duration-700 ${isOpen ? "ml-0" : "-ml-80"}`}>
            <div
                onClick={() => setIsProfileOpen(prev => !prev)}
                onBlur={() => setIsProfileOpen(false)}
                className='z-50 fixed top-10 right-20 flex justify-center items-center gap-2 cursor-pointer duration-300 transition-colors text-white px-24'>
                ...
                <div className={`absolute space-y-3 bg-blueGradient-2/70 filter backdrop-blur-lg p-3 rounded-lg top-14 w-full transition-all duration-300 ${isProfileOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10 invisible'}`}>
                    <Link href={"/account"}>
                        <div className='flex items-center justify-start gap-4 px-1 py-2 w-full hover:bg-blueGradient-2/80'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="inline" viewBox="0 0 16 16">
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                                <path fillRule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
                            </svg>
                    ...
                    <Link href={"/account#settings"}>
                        <div className='flex items-center justify-start gap-4 px-1 py-2 hover:bg-blueGradient-2/80'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-gear-fill inline" viewBox="0 0 16 16">
            ...
            <div className="w-full flex flex-col text-white px-10 py-4 space-y-6">
                ...
                <Link href="/" className="">
                    <span className='hover:text-primary cursor-pointer duration-300 transition-colors'>
                        Ongoing Projects
                    </span>
                </Link>
                <Link href="/">
