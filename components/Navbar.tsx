        ...
        >
          ...
          <ul className="lg:flex justify-center items-center space-x-6">
            ...
            {(!name || !email) && (
              <Link href="/login">
                <button
                  className={`border-gradient-btn gradient-border-2 rounded-lg px-4 py-2 font-bold items-center justify-center transition-colors duration-300 z-[60] text-sm md:text-base }`}
                >
                  {"Login"}
                </button>
              </Link>
