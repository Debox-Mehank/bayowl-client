    ...
    return (
        <div className="z-50">
            ...
            <nav
                ...
                role="navigation"
            >
                <div className={`flex justify-between items-center flex-wrap h-auto w-full z-50 max-w-7xl mx-auto `}>
                    {/* For Desktop */}
                    <div className="hidden md:block lg:block">
                        <Link href="/">
                            <a className="items-center mx-8 my-4 inline-flex">

                                <svg height={scrolled ? 80 : 100} width={scrolled ? 170 : 200} className={`${scrolled ? "fill-white" : "fill-white"} hover:fill-primary transition-colors duration-300 cursor-pointer`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 715.02 158.51" >
                    ...
                    <ul className="hidden lg:block space-x-6">
                        ...
                        <Link href="/login">
                            <button className={`border-gradient-btn gradient-border-2 rounded-lg px-4 py-2 font-bold items-center justify-center transition-colors duration-300 z-[60] text-sm md:text-base }`}>
                                {"Login"}
                            </button>
