...
function Accordion({ service, modalTrigger }: Props) {
    ...
    return (
        <div
            ...
            <div className={`filter backdrop-blur-lg rounded-lg top-14 w-full transition-all duration-300 overflow-hidden
         ${isOpen ? "max-h-[32rem] duration-500 transition-all ease-in" : "max-h-0 duration-300 transition-all ease-out"}`}>
