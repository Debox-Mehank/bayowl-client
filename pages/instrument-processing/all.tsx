...
const Mix: NextPage = () => {
    ...
    const [activeService, setactiveService] = useState<string | null>("Instrument Processing")
    const [activeCat, setactiveCat] = useState<string | null>("All Instruments")
