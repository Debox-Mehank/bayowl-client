    ...
    <div className="h-screen flex justify-center items-center bg-darkBlue text-white relative max-w-7xl mx-auto">
      ...
      <div className="mx-auto w-4/6 bg-white/10 rounded-2xl p-4 flex items-center">
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className=" mx-auto w-16 h-16 mb-1 text-primary"
        >
          <path
            strokeLinecap="round"
        ...
        <div>
          ...
          <div className="text-center">
            <p>
              {
                "If you'd like a GST invoice copy, please mail a copy of your GST certificate to accounts@bayowlstudios.com."
              }
            </p>
            <p>
              {"You will shortly receive the purchase summary on your email."}
            </p>
          </div>
        </div>
      </div>
