...
const ResetPass: NextPage = () => {
  const [resetQuery] = useResetPasswordLazyQuery();
  ...
  const handleSubmit = async () => {
    ...
    if (details.newPass !== details.confirmNewPass) {
      toast.error(
        "Both passwords do not match, please check both the passwords are same and continue"
      );
      return;
    }
    ...
    try {
      ...
      toast.success("Congragulations your password has been reset.", {
        duration: 3000,
      });
      router.replace("/");
    } catch (error: any) {
            ...
            <div className="space-y-6">
              <div className="w-full bg-black/30 flex items-center rounded-xl pr-2 ">
                <input
                  ...
                  onChange={(e) =>
                    setDetails((prev) => ({ ...prev, newPass: e.target.value }))
                  }
                />
                {!showPassword ? (
                  <svg
