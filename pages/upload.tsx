        ...
        <div className="mx-auto w-4/6 bg-white/10 rounded-2xl h-full">
          <form className="w-full h-full" name="files" action="">
            {(!file || filesArray.length <= 0) && (
              ...
              >
                <div
                  className={`w-full h-full cursor-pointer bg-white/10 flex flex-col gap-8 py-10 rounded-xl ${
                    !file || filesArray.length <= 0
            ...
            {file && filesArray.length > 0 && (
              <div className="w-full h-full py-10">
                ...
                <div className="h-1/4 px-8 flex flex-col justify-around">
                  ...
                  <textarea
                    className="bg-darkBlue/20 rounded-xl w-full h-full my-10"
                    name=""
                    id="remarks"
                    placeholder="Please mention any preferences or special requests here."
                  />
                  <div className="flex justify-between z-50">
                    <div onClick={() => setIsRefModalOpen(true)}>
