...
function Upload() {
    ...
    const [refLinksArray, setRefLinksArray] = useState<string[]>([]);
                ...
                <div className="mx-auto w-4/6 bg-white/10 rounded-2xl h-full">
                    <form className="w-full h-full" name="files"
                        onSubmit={() => {
                            ...
                            if (isRefByUpload) {
                                // Upload the files to AWS and get URLS.
                                // Append returned URLS to Ref Links Array.
                                // setRefLinksArray([])
                            }
                                                                    ...
                                                                    <svg
                                                                        onClick={() => {
                                                                            ...
                                                                            if (input && isValidHttpUrl(input)) {
                                                                                setRefLinksArray(prev => [...prev, input])
                                                                                urlEl.current.value = "";
                                                                                return
                                                                            }
